	...
	<view class="exact-home">
		...
		<view class="shortcut-section">
			...
			<view class="shortcut-grid">
				...
				<view class="shortcut-item" @click="$emit('catch')"><view class="shortcut-icon icon-record"><view class="icon-shape"></view></view><text>我的钓获</text></view>
...
<style scoped>
	...
	.secondary-actions{padding:0 22rpx 18rpx}.secondary-action{height:82rpx;padding:0 18rpx;display:flex;align-items:center;min-width:0;border:1rpx solid #cbe3e1;border-radius:14rpx;background:#eaf7f5;box-sizing:border-box}.secondary-action:active{background:#dff1ef}.secondary-action-icon{width:50rpx;height:50rpx;flex-shrink:0;display:flex;align-items:center;justify-content:center;border-radius:12rpx;background:#0aa5a2;color:#f7fbfa}.secondary-action-copy{min-width:0;margin-left:14rpx;display:flex;align-items:baseline;gap:14rpx}.secondary-action-copy text:first-child{color:#143f42;font-size:23rpx;font-weight:900;white-space:nowrap}.secondary-action-copy text:last-child{color:#698082;font-size:18rpx;white-space:nowrap}.weigh-scale{width:32rpx;height:31rpx;position:relative;box-sizing:border-box}.weigh-scale::before{content:'';position:absolute;left:1rpx;right:1rpx;bottom:0;height:21rpx;border:3rpx solid currentColor;border-radius:6rpx;box-sizing:border-box}.weigh-scale::after{content:'';position:absolute;left:8rpx;top:0;width:17rpx;height:17rpx;border:3rpx solid currentColor;border-radius:50%;background:#0aa5a2;box-sizing:border-box}.weigh-scale view{position:absolute;z-index:1;left:15rpx;top:4rpx;width:3rpx;height:7rpx;border-radius:99rpx;background:currentColor;transform:rotate(35deg);transform-origin:bottom}
	...
	.icon-record .icon-shape{width:34rpx;height:40rpx;border:4rpx solid currentColor;border-radius:5rpx}.icon-record .icon-shape::before{content:'';position:absolute;left:7rpx;right:7rpx;top:10rpx;border-top:3rpx solid currentColor;box-shadow:0 8rpx 0 currentColor,0 16rpx 0 currentColor}
	...
	@media (max-width:360px){.home-hero{height:470rpx}.control-sheet{margin-left:16rpx;margin-right:16rpx}.primary-actions{padding-left:16rpx;padding-right:16rpx}.settle-action{margin-left:15rpx;padding-left:15rpx;font-size:23rpx}.secondary-actions{padding-left:16rpx;padding-right:16rpx}.secondary-action{padding-left:13rpx;padding-right:12rpx}.secondary-action-copy{margin-left:10rpx;gap:9rpx}.secondary-action-copy text:first-child{font-size:21rpx}.secondary-action-copy text:last-child{font-size:16rpx}.shortcut-section,.news-section{padding-left:18rpx;padding-right:18rpx}.shortcut-grid{row-gap:24rpx}.shortcut-item{font-size:19rpx}.news-layout{height:246rpx}.event-feature{padding-left:14rpx;padding-right:14rpx}.event-title{font-size:22rpx}.home-tabbar{padding-left:56rpx;padding-right:56rpx}}
