<template>
	<view class="exact-home">
		...
		<view class="weigh-entry" @click="$emit('weigh')">
			<view class="weigh-entry-icon"><view class="weigh-scale"><view></view></view></view>
			<view class="weigh-entry-copy">
				<text class="weigh-entry-title">鱼获称重</text>
				<text class="weigh-entry-desc">录入重量，自动按会员价格计价</text>
			</view>
			<text class="weigh-entry-tag">现场结算</text>
		...
		<view class="shortcut-section">
			...
			<view class="shortcut-grid">
				...
				<view class="shortcut-item" @click="$emit('member')"><view class="shortcut-icon icon-person"><view class="icon-shape"></view></view><text>会员中心</text></view>
...
<style scoped>
	...
	.weigh-entry{min-height:106rpx;margin:16rpx 20rpx 0;padding:14rpx 18rpx;display:flex;align-items:center;border:1rpx solid #cfe5e3;border-radius:16rpx;background:#edf8f6;color:#143f42;box-sizing:border-box}.weigh-entry:active{background:#e3f3f1}.weigh-entry-icon{width:70rpx;height:70rpx;flex-shrink:0;display:flex;align-items:center;justify-content:center;border-radius:15rpx;background:#0aa5a2;color:#f7fbfa}.weigh-scale{width:42rpx;height:40rpx;position:relative;box-sizing:border-box}.weigh-scale::before{content:'';position:absolute;left:2rpx;right:2rpx;bottom:0;height:26rpx;border:4rpx solid currentColor;border-radius:7rpx;box-sizing:border-box}.weigh-scale::after{content:'';position:absolute;left:11rpx;top:0;width:20rpx;height:20rpx;border:4rpx solid currentColor;border-radius:50%;background:#0aa5a2;box-sizing:border-box}.weigh-scale view{position:absolute;z-index:1;left:20rpx;top:5rpx;width:3rpx;height:8rpx;border-radius:99rpx;background:currentColor;transform:rotate(35deg);transform-origin:bottom}.weigh-entry-copy{flex:1;min-width:0;margin-left:16rpx;display:flex;flex-direction:column}.weigh-entry-title{font-size:25rpx;font-weight:900}.weigh-entry-desc{margin-top:5rpx;overflow:hidden;color:#647d7f;font-size:19rpx;white-space:nowrap;text-overflow:ellipsis}.weigh-entry-tag{margin-left:12rpx;padding:6rpx 10rpx;border-radius:7rpx;background:#d8efec;color:#087f7d;font-size:17rpx;font-weight:800}.weigh-entry-arrow{margin-left:10rpx;color:#6f898a;font-size:32rpx;font-weight:300}
</style>
